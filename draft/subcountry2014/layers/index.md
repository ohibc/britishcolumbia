...
| value range       | 0.503129 to 0.503129                               |
...
| value units       | pressure score                                                      |
| value range       | 0.2182894 to 0.2182894                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.09020709 to 0.09020709                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.8272328 to 0.8272328                               |
| global extraction | raster | equal:  |
...
| value units       | km^2                                                      |
| value range       | 0.00841278 to 242.6945                               |
...
| value range       | 0.01271525 to 0.01271525                               |
...
| value units       | trend score                                                      |
| value range       | -0.3346408 to -0.3346408                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | 0.001803341 to 0.001803341                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | 0.013565 to 0.013565                               |
| global extraction | equal: global trends were applied equally to all regions. |
...
| value range       | 0.001220772 to 0.394775                               |
...
| value units       | pressure score                                                      |
| value range       | 0.04590533 to 0.04590533                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | pressure score                                                      |
| value range       | 0.03899401 to 0.03899401                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | value                                                      |
| value range       | 0.8479303 to 0.8479303                               |
...
| value units       | pressure score                                                      |
| value range       | 5.881048e-08 to 0.007800397                               |
...
| value range       | 2313314 to 863651245184                               |
...
| value units       | jobs                                                      |
| value range       | 55.2108 to 9621812                               |
...
| value units       | resilience score                                                      |
| value range       | 0.7428571 to 0.7428571                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | people                                                      |
| value range       | 19.52465 to 2997684                               |
...
| value units       | score                                                      |
| value range       | 0.002185684 to 0.7515319                               |
...
| value range       | 0.002408468 to 6529.4                               |
...
| value units       | pressure score                                                      |
| value range       | 0.03153757 to 0.03153757                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.03750711 to 0.03750711                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.00117498 to 0.00117498                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.0074835 to 0.0074835                               |
| global extraction | raster | equal:  |
...
| value units       | pressure score                                                      |
| value range       | 0.0007561039 to 0.0007561039                               |
| global extraction | raster: spatial data was extracted for each region.  |
...
| value units       | pressure score                                                      |
| value range       | 0.4583101 to 0.4583101                               |
| global extraction | equal: global pressures data were applied equally to all regions. |
...
| value units       | km^2                                                      |
| value range       | 6979.99 to 2257200                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 351.0522 to 94628.04                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | km^2                                                      |
| value range       | 1503.81 to 344396.9                               |
| global extraction | raster: spatial data was extracted for each region. |
...
| value units       | resilience score                                                      |
| value range       | 0.8422362 to 0.8422362                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | resilience score                                                      |
| value range       | 0.8865175 to 0.8865175                               |
| global extraction | equal: global resilience data were applied equally to all regions. |
...
| value units       | trend score                                                      |
| value range       | -0.0787569 to -0.0787569                               |
| global extraction | equal: global trends were applied equally to each region.  |
...
| value units       | jobs                                                      |
| value range       | 0.8836687 to 223020.6                               |
